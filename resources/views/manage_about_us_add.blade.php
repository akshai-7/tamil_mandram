            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item "> <a href="{{ route('manage_about_us')}}" class="hover1">Banner</li>
                        <li class="breadcrumb-item active "> &nbsp; / <a> Add About us </a></li>
                    </ol>
                            ...
                            <div class="row" style="padding: 15px;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="name" id="file-input" type="text" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class=" summernote" row="20" column="10"> </textarea>
                                    </div>
                                </div>
