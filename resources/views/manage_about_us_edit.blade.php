            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item "> <a href="{{ route('manage_about_us')}}" class="hover1">Manage About Us</li>
                        <li class="breadcrumb-item active "> &nbsp; / <a> Edit  </a></li>
                    </ol>
                    <a class="btn btn-primary  pull-right" href="{{ url('manage_about_us') }}">Back</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                            ...
                            <div class="row" style="padding: 15px;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="name" id="file-input" type="text" class="form-control" value="Sathis">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class=" summernote" row="20" column="10"> Senior Executive Committee Member </textarea>
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">User Photo upload</label>
