                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card ">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="edit_event" method="POST" action="{{ route('event.update', encrypt($data->id)) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="event_title" id="event_title"
                                                    class="form-control" value="{{ @$data->event_name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="event_date" id="event_date"
                                                    ...
                                                    value="{{ @$data->event_date ? date('m-d-Y', strtotime($data->event_date)) : '' }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control summernote" name="event_description" id="event_description">{{ @$data->event_description }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="event_photo_gallery_link"
                                                    ...
                                                    value="{{ @$data->event_photo_gallery_link }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="event_by_ticket_link" id="event_by_ticket_link"
                                                    class="form-control" value="{{ @$data->event_by_ticket_link }}">
                                            </div>
                                        </div>
