<div class="row">
    <div class="col-12 ">
        <a class="btn btn-primary pull-right" data-toggle="modal" data-target="#feed-modal-add"> + Add Question </a>
    </div>
</div>
    ...
    <table class="table table-bordered table-striped common-table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="custom-control lg-btn btn-active custom-switch custom-switch-off-danger custom-switch-on-success">
