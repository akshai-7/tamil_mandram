...
<div class="content-wrapper">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on("change", "#feed-modal-edit .question-form", function() {
                console.log($(this).val());
