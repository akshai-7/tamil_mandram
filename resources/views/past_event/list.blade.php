            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{url('event')}}">Past Event</a></li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header " style="padding: 0;background-color: #fff;">
                            ...
                            <a href="{{route('past_event_add')}}" class="btn btn-primary pull-right " > + Add Event<a>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped ">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>14th year celebration </td>
                                        <td><span class="badge bg-success">Active</span></td>
                                        <td>
                                            <a href="{{route('past_event_edit')}}" data-target="#modal-edit" title="Edit"> <i class="fa fa-edit" style="color:green"></i></a>
