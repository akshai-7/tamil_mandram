            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item "> <a href="{{ route('past_event')}}" class="hover1">Past Event</li>
                        <li class="breadcrumb-item active "> &nbsp; / <a> Edit Event </a></li>
                    </ol>
                    <a class="btn btn-primary  pull-right" href="{{ url('past_event') }}">Back</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="language" id="language" class="form-control" value="14th year celebration">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control summernote"> 14th year celebration</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Link</label>
                                            <input type="text" name="language" id="language" class="form-control" value="https://www.youtube.com/watch?v=KLAEwukvuZs">
                                        </div>
                                    </div>
