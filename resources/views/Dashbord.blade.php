                ...
                <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('org_id', @$orgs, @$org_id,['class' => 'form-control',"id"=>"org_id","placeholder"=>"Select organization"]) !!}
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mt-4">
                                            <label></label>
                                            <a href="{{route('dashboard')}}" class="btn btn-primary col-md-4"></i>Reset </a>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-3 col-6 " >
                            ...
                            <div class="small-box bg-info">
                                ...
                                <!-- <a href="{{route('organization.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> -->
                            </div>
                        </div>
                        @endif
                        <!-- ./col -->
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header" style="    background-color: #fff !important;">
                                    ...
                                    <div class="pull-right d-none">
                                        <select class="form-control  select2 mr-5" name="user">
                                            <option>Select organization</option>
                                            <option value="1"> Tamil Mandram </option>
                        ...
                        <div class="col-6 offset-md-3">
                            <div class="card">
                                <div class="card-header" style="    background-color: #fff !important;">
                                    <h3 class="card-title text-center"> Subscription types </h3>
                                </div>
                                <div class="card-body">
...
<div id="event_subscription" data-value ={{json_encode($event_subscription)}}></div>
<!-- /.content -->
...
<script>
    ...
    var event_subscription = $("#event_subscription").data('value');
    ...
    if ($('#barChart1').length) {
        ...
        var xValues1 = ["Scaffolding", "General Administration", "Construction", "Inspecting heating", "ventilation systems"];
