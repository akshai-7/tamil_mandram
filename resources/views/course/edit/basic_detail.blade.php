        ...
        <div class="col-md-6">
            <div>
                <div class="form-group">
                    ...
                    <input type="text" value ="General Administration" name="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Course Title">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control select2">
                    ...
                    <option selected value="">Construction technology</option>
        ...
        <div class="col-md-6">
            <div>
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" placeholder="">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</textarea>
                </div>
            </div>
        </div>
        <div class="col-md-6">
