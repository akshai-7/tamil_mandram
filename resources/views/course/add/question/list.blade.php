    ...
    <table class="table table-bordered table-striped common-table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="custom-control  custom-switch lg-btn  custom-switch-off-danger custom-switch-on-success"> <input type="checkbox" checked class="custom-control-input" id="customSwitch2" data-id="#div3">
                    <label class="custom-control-label" for="customSwitch2"></label></div>
                </td>
                <td>
                <label class="mr-5"><i class="fas fa-edit" style="color:green;margin-top: 13px;" title="Edit" data-toggle="modal" data-target="#modal-edit"></i></label></td>
            </tr>
            <tr>
                <td>2</td>
                ...
                <td>
                <label title ="edit" class="mr-5"><i class="fas fa-edit" style="color:green;margin-top: 13px;" title="Edit" data-toggle="modal" data-target="#modal-edit"></i></label>                    </div>
                </td>
            </tr>
        </tbody>
    </table>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group"><label class="label"> Questions Type</label>
                            <select class="form-control select2 question-form " >
