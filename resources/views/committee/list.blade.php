            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{url('committee')}}">Youth Committee</a></li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header " style="padding: 0;background-color: #fff;">
                            ...
                            <a href="{{route('committee_add')}}" class="btn btn-primary pull-right " > + Add <a>
                            ...
                            <table id="example1" class="table table-bordered table-striped ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('committee_edit')}}" data-target="#modal-edit" title="Edit"> <i class="fa fa-edit" style="color:green"></i></a>
