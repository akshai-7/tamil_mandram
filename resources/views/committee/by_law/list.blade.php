            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{url('by_law')}}">By-laws</a></li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header " style="padding: 0;background-color: #fff;">
                            ...
                            <a href="{{route('by_law_add')}}" class="btn btn-primary pull-right "> + Add by-laws<a>
                            ...
                            <table id="example1" class="table table-bordered table-striped ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('by_law_edit')}}" data-target="#modal-edit" title="Edit"> <i class="fa fa-edit" style="color:green"></i></a>
                                            <a title="Delete"> <i class="fa fa-trash" style="color:red"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Location of Principal Office</td>
                                        <td><span class="badge bg-success">Active</span></td>
                                        <td>
                                            <a href="{{route('by_law_edit')}}" data-target="#modal-edit" title="Edit"> <i class="fa fa-edit" style="color:green"></i></a>
                                            <a title="Delete"> <i class="fa fa-trash" style="color:red"></i></a>
