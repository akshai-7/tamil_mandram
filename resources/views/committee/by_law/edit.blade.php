            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item "> <a href="{{ route('by_law')}}" class="hover1">By-laws</li>
                        <li class="breadcrumb-item active "> &nbsp; / <a> Edit by-laws </a></li>
                    </ol>
                    <a class="btn btn-primary  pull-right" href="{{ url('by_law') }}">Back</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label> Title</label>
                                            <input type="text" name="language" id="language" class="form-control" value="Definitions">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control summernote"> (a) All defined terms contained herein will be in the articles of incorporation of the association. It shall have the same meanings as such defined in the articles.
                                                <br>
                                            (b) Jacksonville Tamil Mandram Inc. (Association) will be organized by residents of Northeast Florida and adjoining areas.</textarea>
                                        </div>
                                    </div>
