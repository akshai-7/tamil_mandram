            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{url('organization')}}" class="hover1">Organizations </a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="orginatitionadd" action="{{ route('organization.store') }}" class="tabcontent" method="POST" enctype="multipart/form-data" accept-charset="utf-8" novalidate="novalidate">
                                @csrf
                                <div class="row">
                                    <!-- left column -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="org_name" class="form-control" id="org_name" placeholder="Organization name" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="org_code" class="form-control" id="org_code" placeholder="Organization code" readOnly value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="org_email" class="form-control" id="org_email" placeholder="Email id" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" placeholder="Mobile Number" value="" id="u_mobile_no" name="u_mobile_no">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input name="image" id="file-input" accept="image/jpg,image/jpeg,image/png" class="form-control" type="file" data-error="#errNm1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-1 mt-3 ml-4">
                                        <img class="cropped  preview-img  no-broder" data-toggle="modal" data-target="#getCroppedCanvasModal" src="{{asset('/public/assets/dist/img/photo.png')}}" src="" alt="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <input type="text" name="next_renewal_date" class="form-control datepicker" id="next_renewal_date" placeholder="Next renewal date" value="" readonly>
                                    ...
                                    <div class="col-md-3 ">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control lg-btn custom-switch custom-switch-off-danger custom-switch-on-success">
                                                <input type="checkbox" name="status" checked class="custom-control-input" name="status" id="status" value="1">
                                                <label class="custom-control-label no-change status" for="status"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
